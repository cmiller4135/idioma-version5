...
const Sub3 = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const prompt = `Please provide a list of 10 Spanish words related to ${selectedSubject} along with their English translations. After each word, provide 2 example sentences using the word.`;
